...
import { EditBitstreamPageAlertsComponent } from 'src/app/bitstream-page/edit-bitstream-page-alerts/edit-bitstream-page-alerts.component';
...
const DECLARATIONS = [
  ...
  LogInComponent,
  LangSwitchComponent, EditBitstreamPageAlertsComponent
];
